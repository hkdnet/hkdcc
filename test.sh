...
# var
try 1 'int main() { return a = 1; }'
try 1 'int main() { a = 1; return a; }'
try 2 'int main() { a = 1; return a + 1; }'
try 2 'int main() { a = b = 1; return a + b; }'

# var of 2 or more characters
try 1 'int main() { return ab = 1; }'
try 1 'int main() { ab = 1; return ab; }'
try 2 'int main() { ab = 1; return ab + 1; }'
try 2 'int main() { ab = cd = 1; return ab + cd; }'
try 3 'int main() { a = 1; ab = 2; return a + ab; }'

# eqeq
try 1 'int main() { return 1 == 1; }'
try 1 'int main() { a = 1; return 1 == a; }'
try 0 'int main() { a = 2; return 1 == a; }'
try 0 'int main() { a = 2; return a == 1; }'
try 0 'int main() { a = 0 == 1; return a; }'
...
try 1 'int main() { if (a=1) return 1; return 0; }'
try 0 'int main() { if (a=0) return 1; return 0; }'
try 1 'int main() { if (a=1) return a; return 2; }'
try 0 'int main() { if (a=0) return 2; return a; }'
...
try 0 'int main() { a = 1; if (1) a = 0; return a; }'
try 1 'int main() { a = 1; if (0) a = 0; return a; }'

# while
try 0 'int main() { a = 3; while (a != 0) a = baz(a); return a; }'
try 0 'int main() { a = 1; while (a = 0) return 128; return a; }'
